/**
 * Utilidades para validar RNC y Cédula de la República Dominicana
 */

/**
 * Valida el formato de RNC o Cédula
 * RNC: 9 o 11 dígitos (puede incluir guiones)
 * Cédula: 11 dígitos
 */
export const validateIdentificationFormat = (identification: string): {
  ...
  if (cleanId.length === 9) {
    ...
    // Las cédulas normalmente comienzan con 0, 1, 2
    // Los RNC de 11 dígitos son menos comunes
    ...
    // RNC de 10 dígitos (formato antiguo, menos común)
    return {
      isValid: true,
      type: 'RNC',
    };
 ...
 * Algoritmo para RNC de 9 dígitos
 */
 ...
 * Algoritmo para Cédula de 11 dígitos
 */
